...
const settingSections = [
  {
    ...
    icon: Bell,
    settings: [
      { label: "Email notifications for new reports", enabled: true },
      { label: "Push notifications for high-risk alerts", enabled: true },
  ...
  },
  {
    ...
    settings: [
      ...
      { label: "Show profile to patients", enabled: true },
    ],
  },
  {
    title: "Preferences",
    ...
    settings: [
      ...
      { label: "Auto-refresh dashboard", enabled: true },
    ],
  },
];
